...
public enum StrategyCode {
    ...
    DAILY_TOUCH_MA60_KR("DAILY_TOUCH_MA60_KR", "일봉 60일선 터치", "KR"),
    ...
    DUAL_MOMENTUM_1M_KR("DUAL_MOMENTUM_1M_KR","듀얼모멘텀 30일 기준","KR"),
    ...
    DAILY_TOUCH_MA60_US("DAILY_TOUCH_MA60_US", "일봉 60일선 터치", "US"),

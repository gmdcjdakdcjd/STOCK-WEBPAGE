...
public enum KRStrategy {
    ...
    DAILY_120D_NEW_HIGH_KR("[일봉] 120일 신고가 (원)"),
    DAILY_120D_NEW_LOW_KR("[일봉] 120일 신저가 (원)"),
    WEEKLY_52W_NEW_HIGH_KR("[주봉] 52주 신고가 (원)"),
    WEEKLY_52W_NEW_LOW_KR("[주봉] 52주 신저가 (원)"),
    DAILY_BB_LOWER_TOUCH_KR("[일봉] 볼린저밴드 하단선 터치값 (원)"),
    DAILY_BB_UPPER_TOUCH_KR("[일봉] 볼린저밴드 상단선 터치값 (원)"),
    WEEKLY_BB_LOWER_TOUCH_KR("[주봉] 볼린저밴드 하단선 터치값 (원)"),
    WEEKLY_BB_UPPER_TOUCH_KR("[주봉] 볼린저밴드 상단선 터치값 (원)"),
    ...
    DAILY_TOUCH_MA20_KR("[일봉] 20일선 터치값 (원)"),
    DAILY_TOUCH_MA60_KR("[일봉] 60일선 터치값 (원)"),
    DAILY_TOUCH_MA120_KR("[일봉] 120일선 터치값 (원)"),
    WEEKLY_TOUCH_MA20_KR("[주봉] 20주선 터치값 (원)"),
    WEEKLY_TOUCH_MA60_KR("[주봉] 60주선 터치값 (원)"),
    WEEKLY_TOUCH_MA120_KR("[주봉] 120주선 터치값 (원)");
